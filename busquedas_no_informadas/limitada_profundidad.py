...
def busqueda_Limitaprofundidad(tablero, lista_nodos_iniciales, meta, maximo_iteraciones, visitado, graph):
    ...
    while pila:
        ...
        for movimiento in [(0, -1), (-1, 0), (0, 1), (1, 0)]: # Movimientos posibles abajo, izquierda, arriba, derecha
            ...
            if es_valido(nueva_fila, nueva_colum, tablero) and tablero[nueva_fila][nueva_colum] != '#' and not visitado.get((nueva_fila, nueva_colum), False):
                ...
                graph.graficar_arbol(nuevo_nodo, "Busqueda en Limitada Profundidad")
